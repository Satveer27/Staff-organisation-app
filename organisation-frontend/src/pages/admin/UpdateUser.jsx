    ...
    <>
      ...
      <section className='mt-10'>
        ...
        <div className='flex items-center justify-center flex-col lg:px-[400px] px-4 mb-14'>
          ...
          <input required type="text" className="placeholder:text-gray-500 w-full mb-4 px-12 py-5 border border-gray-200 focus:ring-blue-300 focus:border-blue-300 rounded-md" id='employeeIdNo' name="employeeIdNo" value={formData?.employeeIdNo} placeholder='Enter employee id' onChange={onChange}/>
          <label className="block text-sm font-medium text-gray-700">
                  Employee Role
          </label>
          <input required type="text" className="placeholder:text-gray-500 w-full mb-4 px-12 py-5 border border-gray-200 focus:ring-blue-300 focus:border-blue-300 rounded-md" id='role' name="role" value={formData?.role} placeholder='Enter employee role' onChange={onChange}/>
          <label className="block text-sm font-medium text-gray-700">
                  Phone number
          </label>
          <input required type="tel" className="placeholder:text-gray-500 w-full mb-4 px-12 py-5 border border-gray-200 focus:ring-blue-300 focus:border-blue-300 rounded-md" id='phoneNumber' name="phoneNumber" value={formData?.phoneNumber} placeholder='Enter your phone number' onChange={onChange}/>
          <label className="block text-sm font-medium text-gray-700">
                  zone
          </label>
          <Select
